            ...
            <div class="col-md-12">
                ...
                <div class="main-block">
                    ...
                    <div class="visible-hover right">
                        <ul class="btn-list">
                            <li><a href="central-inteligencia-single.php" class="border-btn small light-blue"><p>Ver resumen</p></a></li>
                        </ul>
                    </div>
                </div>
                <div class="main-block">
                    <div class="info">
                        ...
                        <div class="author">Síma, M.; Pokorná, P.; Hartinger, J.; Slanar, O. <br>
                            Rev. Journal of Clinical Pharmacy and Therapeutics 2018 Vol. 43 Nro. 2 Página: 196 - 201</div>
                    </div>
                    <div class="visible-hover right">
                        <ul class="btn-list">
                            <li><a href="central-inteligencia-single.php" class="border-btn small light-blue"><p>Ver resumen</p></a></li>
