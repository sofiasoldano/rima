        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="folders-container">
                    ...
                    <a href="biblioteca-single.php" class="folder pink">
                        <img src="img/icons/folder.png" width="47">
                        <p>Para compartir <span class="quantity">8 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder green">
                        <img src="img/icons/folder.png" width="47">
                        <p>Sin título <span class="quantity">18 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder light-blue">
                        <img src="img/icons/folder.png" width="47">
                        <p>Pediatría <span class="quantity">18 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder purple">
                        <img src="img/icons/folder.png" width="47">
                        <p>Temas varios <span class="quantity">18 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder red">
                        <img src="img/icons/folder.png" width="47">
                        <p>Sin título <span class="quantity">18 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder light-gray">
                        <img src="img/icons/folder.png" width="47">
                        <p>Sin título <span class="quantity">18 artículos</span></p>
                    </a>
                    <a href="biblioteca-single.php" class="folder orange">
                        <img src="img/icons/folder.png" width="47">
