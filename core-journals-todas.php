    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 hidden-md">
                <div class="title left">Acervo Completo - 2451 revistas</div>
                <div class="search right">
                    <form>
                        <input type="search" placeholder="Ingrese el nombre o parte del nombre de la revista:" class="input-search">
